...
ROOT_DIR = environ.Path(__file__) - 3  # (ask/config/settings/base.py - 3 = ask/)
APPS_DIR = ROOT_DIR.path('ask')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'ask.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Timothy James Birkett""", 'tim.birkett@itv.com'),
]
...
#ACCOUNT_ADAPTER = 'askitv.users.adapters.AccountAdapter'
#SOCIALACCOUNT_ADAPTER = 'askitv.users.adapters.SocialAccountAdapter'
